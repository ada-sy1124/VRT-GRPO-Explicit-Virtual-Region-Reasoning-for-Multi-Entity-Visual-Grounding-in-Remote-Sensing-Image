"""Run Qwen VRT inference with the SFT LoRA adapter."""
...
OUTPUT_JSONL = os.environ.get("OUTPUT_JSONL", "/root/autodl-tmp/SPIN/outputs/output_qwen3/vrt_test_sft.jsonl")
...
def main():
    ...
    if rank == 0:
        print(f"Loading and merging SFT LoRA: {sft_adapter_path}")
...
# 4-GPU:
# CUDA_VISIBLE_DEVICES=0,1,2,3 torchrun --standalone --nproc_per_node=4 code/eval/infer_qwen_vrt_lora.py
