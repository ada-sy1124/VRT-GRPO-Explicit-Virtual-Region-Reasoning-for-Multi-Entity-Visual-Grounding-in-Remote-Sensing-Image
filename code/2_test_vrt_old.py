"""Legacy VRT inference script retained for traceability.

Prefer the organized Qwen and InternVL inference scripts under code/eval/ for new runs."""
...
LORA_ADAPTER_PATH = "/root/autodl-tmp/SPIN/output_InternVL3_5/vrt_sft_lora/v4-20260818-024753/checkpoint-255"
# LORA_ADAPTER_PATH = "/root/autodl-tmp/SPIN/output/vrt_grpo_sftinit_r16_g8_h20x4_final/checkpoint-1397"
USE_LORA = True
AUTO_FIND_LATEST_LORA = False

OUTPUT_JSONL = "/root/autodl-tmp/SPIN/output_InternVL3_5/vrt_test_sft.jsonl"
...
def main():
    ...
    if USE_LORA:
        adapter_path = find_latest_lora_adapter(LORA_ADAPTER_PATH) if AUTO_FIND_LATEST_LORA else LORA_ADAPTER_PATH
        if rank == 0:
...
# python ./2_test_vrt.py


# CUDA_VISIBLE_DEVICES=0,1,2,3 \
# torchrun --standalone --nproc_per_node=4 ./2_test_vrt_old.py